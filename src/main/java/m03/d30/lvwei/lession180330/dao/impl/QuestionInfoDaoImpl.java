...
package m03.d30.lvwei.lession180330.dao.impl;

import java.util.ArrayList;
import java.util.List;

import m03.d30.lvwei.lession180330.dao.BaseDao;
...
public class QuestionInfoDaoImpl extends BaseDao implements QuestionInfoDao {
    ...
    public List<QuestionInfo> Callups_test_01() {
        List<QuestionInfo> listinfo1 = new ArrayList<QuestionInfo>();
        try {
    ...
    @Override
    public List Callups_test_02(String srt) {

        List<QuestionInfo> list = new ArrayList<QuestionInfo>();
        try {
            String sql = "CALL ups_test_02(" + srt + ")";
            pst = getCon().prepareStatement(sql);
            rs = pst.executeQuery();
            while (rs.next()) {
                QuestionInfo ff = new QuestionInfo();
