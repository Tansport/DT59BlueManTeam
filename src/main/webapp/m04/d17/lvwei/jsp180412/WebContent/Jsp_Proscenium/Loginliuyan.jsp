...
<BODY leftMargin=0 topMargin=0 marginheight="0" marginwidth="0">
	<form action="<%=path %>/Mess" method="post" target="_parent">
		<table width="399" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td align="left" bordercolor="#EBEBEB" bgcolor="#EBEBEB"><input
					type="text" id="cd" value="" readonly="readonly" name="code" /> <input
					type="button" value="获取验证码" id="code" onclick="createCode()" /></td>
			</tr>
			<tr align="left">
