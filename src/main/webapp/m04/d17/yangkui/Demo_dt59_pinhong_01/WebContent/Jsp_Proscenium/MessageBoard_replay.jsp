...
<body background="Img_Background/1/bookbg.gif">
	<table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
	  ...
	  <tr>
	    <td height="25" colspan="4"><span class="title">主题: ${mess.mtitle }</span></td>
	  </tr>
	  <tr>
	    ...
	    <td colspan="4"><table width="750" height="148" border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        <td><table width="750" height="54" border="0" cellpadding="0" cellspacing="0">
	          <tr>
	            <td height="22" background="Img_Background/1/title.gif" class="ltr"><font style="font-size: 12px; font-weight: bold;">&nbsp;&nbsp;※&nbsp;&nbsp;${mess.mtitle }</font></td>
	          </tr>
	          <tr>
	            <td height="20" class="lr" ><p class="content">&nbsp;${mess.mcontent }</p></td>
	          </tr>
	          <tr>
	            <td height="100" class="lrb">&nbsp;</td>
	          </tr>
	          <tr>
	            <td height="20" class="lrb"><span class="gray">&nbsp;${mess.mname }&nbsp;写于&nbsp;${mess.mdate }</span></td>
	          </tr>
	        </table></td>
	      </tr>
	    </table></td>
	                  ...
	                  <td><table width="750" border="0" cellspacing="0" cellpadding="0">
	                    ...
	                    <tr>
	                      <td><table width="750" height="54" border="0" cellpadding="0" cellspacing="0">
	                        ...
	                        <tr>
	                          <td height="20" class="lrb"><span class="gray">&nbsp;${re.rname }&nbsp;写于&nbsp;${re.rtate }</span></td>
	                        </tr>
	                      </table></td>
	                    </tr>
	                    <tr>
	  ...
	  <tr>
	    <td height="25" colspan="4"><form id="form1" name="form1" method="post" action="<%=path %>/Srevert" target="_parent">
	        ...
	        <tr>
	          ...
	          <table width="750" border="0" cellpadding="0" cellspacing="0">
	            <tr>
	              ...
	              <input name="messageid" type="hidden" value="${mess.mid }" size="5" />
	              </td>
	            </tr>
	            <tr>
	            ...
	            <tr>
	              ...
	              <td width="642" class="right"><label>
	                <input type="text" value="${loginName }" name="name" size="15"/>
	                </label></td>
	            </tr>
	              </c:if> 
	            <tr>
	            ...
	            <tr>
	              ...
	              <tr>
	              <td>您好！留言需<a href="Jsp_Proscenium/Login.jsp" style="text-decoration: none">登录</a>！</td>
	              </tr>
	            <tr>
	              <td colspan="3">&nbsp;</td>
	              </tr>
