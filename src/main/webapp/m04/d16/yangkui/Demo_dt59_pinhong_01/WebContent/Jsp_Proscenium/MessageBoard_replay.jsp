...
<body background="Img_Background/1/bookbg.gif">
	...
	<c:forEach items="${listmess}" var="n">
	<c:if test="${not empty listmess}">
	  <tr>
	    <td height="25" colspan="4"><span class="title">主题: ${n.mtitle }</span></td>
	  </tr>
	  <tr>
	    ...
	    <td colspan="4"><table width="750" height="148" border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        <td><table width="750" height="54" border="0" cellpadding="0" cellspacing="0">
	          <tr>
	            <td height="22" background="Img_Background/1/title.gif" class="ltr"><font style="font-size: 12px; font-weight: bold;">&nbsp;&nbsp;※&nbsp;&nbsp;${n.mtitle }</font></td>
	          </tr>
	          <tr>
	                  ...
	                  <td><table width="750" border="0" cellspacing="0" cellpadding="0">
	                    ...
	                    <tr>
	                      <td><table width="750" height="54" border="0" cellpadding="0" cellspacing="0">
	                        ...
	                        <tr>
	                          <td height="20" class="lrb"><span class="gray">&nbsp;${re.rname }&nbsp;写于&nbsp;${re.rpate }</span></td>
	                        </tr>
	                      </table></td>
	                    </tr>
	                    <tr>
