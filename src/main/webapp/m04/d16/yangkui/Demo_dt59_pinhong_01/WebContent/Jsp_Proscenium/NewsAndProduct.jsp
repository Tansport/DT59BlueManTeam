	  ...
	  <tr height="35">
		...
		<td rowspan="16">
		 ...
		 <%-- <c:if test="${not empty newsList}"> --%>
			...
			%> --%>
			<%-- <c:-forEach items="${listnews }" var="lst"></c:-forEach> --%>
			
				 <tr>
					<td height="22">&nbsp;<li style="list-style:none;" ><a target="_parent" href="News?id=${n.ntitle }">${n.ntitle }&nbsp;&nbsp;&nbsp;<span style="color: red;">[${n.ndate}]</span></a></td>
				</li></tr>
			  	<tr>
