...
<body background="Img_Background/1/bookbg.gif">
	<table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
	  <tr>
	    <td height="25" colspan="4"><span class="title">主题: ${messListById.mtitle }</span></td>
	  </tr>
	  <tr>
	    ...
	    <td colspan="4"><table width="750" height="148" border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        <td><table width="750" height="54" border="0" cellpadding="0" cellspacing="0">
	          <tr>
	            <td height="22" background="Img_Background/1/title.gif" class="ltr"><font style="font-size: 12px; font-weight: bold;">&nbsp;&nbsp;※&nbsp;&nbsp;${messListById.mtitle }</font></td>
	          </tr>
	          <tr>
	            <td height="20" class="lr" ><p class="content">&nbsp;${messListById.mcontent }</p></td>
	          </tr>
	          <tr>
	            <td height="100" class="lrb">&nbsp;</td>
	          </tr>
	          <tr>
	            <td height="20" class="lrb"><span class="gray">&nbsp;${messListById.mname }&nbsp;写于&nbsp;${messListById.mdate }</span></td>
	          </tr>
	        </table></td>
	      </tr>
	    </table></td>
	              ...
	              <td><table width="750" height="100" border="0" cellpadding="0" cellspacing="0">
	                <tr>
	                  <td><table width="750" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
	                      <td><img spoi width="140" height="21" /><img src="Img_Background/1/Tt_bg.gif" width="554" height="21" /><img src="Img_Background/1/T_right.gif" width="56" height="21" /></td>
	                    </tr>
	                    <tr>
	                      <td><table width="750" height="54" border="0" cellpadding="0" cellspacing="0">
	                        <tr>
