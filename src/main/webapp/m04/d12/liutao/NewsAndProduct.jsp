<%@page import="com.servlet.entity.News"%>
	...
	<%-- 	<c:if test="${not empty newsList}">
			<c:forEach items="${newsList}" var="n"> --%>
				...
				for(int i=0;i<listnews.size();i++){
				    out.print("<td height='22'>&nbsp;<a target='_parent' href='#'>"+listnews.get(i).getNtitle()+"&nbsp;&nbsp;&nbsp;<span style='color: red;'>["+listnews.get(i).getNdate()+"]</span></a></td>");
				}
				%>
