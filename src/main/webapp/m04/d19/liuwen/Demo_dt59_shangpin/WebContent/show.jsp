		...
		<tbody id="tby">
			<c:forEach items="${map }" var="map">
				<tr>
					...
					<td>
						<a href="javascript:;" name="jf" style="text-decoration: none">-</a> 
						<input type="text" id="num"	name="num" value="${map.value.num }" size="7" /> 
						<a href="javascript:;" name="add" style="text-decoration: none">+</a>
					</td>
