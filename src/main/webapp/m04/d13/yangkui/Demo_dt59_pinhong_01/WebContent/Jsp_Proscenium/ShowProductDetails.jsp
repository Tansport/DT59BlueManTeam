...
<html>
  ...
  <body>
	<table>
		<c:if test="${not empty listpro1}">

			 <c:forEach items="${listpro1}" var="p">
				<tr>
					<td>
		...
		<tr>
			<td><div align="right"><a href="<%=path%>/Spage?currentpage=${page.getCurrentpage()-1}" target="_parent" style="text-decoration:none; color:#999999; font-size:13px;">上一页</a> <span style="font-size:13px; color: #999999;">|</span> <a href="<%=path %>/Spage?currentpage=${page.getCurrentpage()+1}" target="_parent" style="text-decoration:none; color:#999999; font-size:13px;">下一页</a></div></td>
			<td>&nbsp;</td>
		</tr>
	</table>
  </body>
