...
<html>
  ...
  <body>
	<table>
		...
		<tr>
		<% 
			Page pg =(Page)session.getAttribute("page2");
		%>
			<td><div align="right"><a href="Jsp_Proscenium/M_ShowProduct.jsp?currentpage=<%=pg.getCurrentpage()-1 %>" target="_parent" style="text-decoration:none; color:#999999; font-size:13px;">上一页</a> <span style="font-size:13px; color: #999999;">|</span> <a href="Jsp_Proscenium/M_ShowProduct.jsp?currentpage=<%=pg.getCurrentpage() + 1 %>" target="_parent" style="text-decoration:none; color:#999999; font-size:13px;">下一页</a></div></td>
