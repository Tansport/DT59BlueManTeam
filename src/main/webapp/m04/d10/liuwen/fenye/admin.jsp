	...
	<div id="main">
		...
		<div id="opt_area">
			...
			<script language="javascript">
				...
				function modify(id) {
					//alert("modify:"+id);
					window.location.href = "resultModify.jsp?id=" + id;
				}
			</script>
			<ul class="classlist">
				<%
				    ...
				    for (int i = 0; i < listnews.size(); i++) {
				        out.print("<li>" + listnews.get(i).getNewstitle() + "<span>作者:" + listnews.get(i).getNewsauthor()
				                + "&#160;&#160;&#160;&#160; <a href='admin/news_modify.jsp?nid=" + listnews.get(i).getNewsid()
				                + "&ntitle=" + listnews.get(i).getNewstitle() + "&nauthor=" + listnews.get(i).getNewsauthor()
				                + "&nsummary=" + listnews.get(i).getNewssummary() + "&ncontent="
				                + listnews.get(i).getNewscontent() + "'>修改</a> &#160;&#160;&#160;&#160;"
				                + "<a href='javascript:;' onclick='del(" + listnews.get(i).getNewsid()
				                + ");'>删除</a> </span></li>");
				        //out.print(1);
				    }
				%>
				...
				<p align="center">
					<a href="spage.jsp?currentpage=1">首页</a>&nbsp;&nbsp;&nbsp;
					 <a	href="spage.jsp?currentpage=
            			...
            			">上一页</a>&nbsp;&nbsp;&nbsp;
					<a	href="spage.jsp?currentpage=
						<%if((pg.getCurrentpage() + 1) < pg.getLastpage()){
           				...
           				">下一页</a>&nbsp;&nbsp;&nbsp;
					<a href="spage.jsp?currmentpage=<%=pg.getLastpage() %>">末页</a>
					&nbsp;&nbsp;&nbsp;
				</p>
				<h1><%=pg.getCurrentpage() %></h1>
				<!-- 获取不到pg.getLastpage()的值  -->
				<h1><%=pg.getLastpage() %></h1>
			</ul>
		</div>
	</div>
	<div id="site_link">
