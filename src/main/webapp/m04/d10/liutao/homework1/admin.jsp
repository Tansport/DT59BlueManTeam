	...
	<div id="main">
		...
		<div id="opt_area">
			...
			<script language="javascript">
				...
				/* 	function alter(id){
				 alert(id);
				 window.location.href="modification.jsp?id="+id;
				 }
				 */
			</script>
			<ul class="classlist">
				<%
				    ...
				    for (int i = 0; i < listNews.size(); i++) {
				        out.print("<li>" + listNews.get(i).getNews_title() + "<span>作者:" + listNews.get(i).getNews_author()
				                + "&#160;&#160;&#160;&#160;" + "<a href='admin/news_modify.jsp?Id="
				                + listNews.get(i).getNews_id() + "&tId=" + listNews.get(i).getType_id() + "&Author="
				                + listNews.get(i).getNews_author() + "&Title=" + listNews.get(i).getNews_title() + "&Summary="
				                + listNews.get(i).getNews_summary() + "&Content=" + listNews.get(i).getNews_content()
				                + "'>修改</a> &#160;&#160;&#160;&#160;<a href='javascript:;' onclick='del("
				                + listNews.get(i).getNews_id() + ")'>删除</a> <span><li>");
				    }
				%>
      ...
      <li> 国台办将授权福建等六省市部分赴台管理审批权 <span> 作者：
        ...
        &#160;&#160;&#160;&#160; <a href='news_modify.html'>修改</a> &#160;&#160;&#160;&#160; <a href='#' onclick='return clickdel()'>删除</a> </span> </li> -->
				<li class='space'></li>
				<%
				    Page pag = (Page) request.getAttribute("pag");//获取page
				%>
				<p align="right">
					<a href="spage.jsp?currentpage=1">首页</a>&nbsp;&nbsp;&nbsp; <a
						href="spage.jsp?currentpage=<%=pag.getCurrentpage() - 1%>">上一页</a>
					&nbsp;&nbsp;&nbsp; <a
						href="spage.jsp?currentpage=<%=pag.getCurrentpage() + 1%>">下一页</a>
					&nbsp;&nbsp;&nbsp; <a href="spage.jsp?currentpage=<%=pag.getLastpage()%>">末页</a> &nbsp;&nbsp;&nbsp;
				</p>
			</ul>
		</div>
	</div>
