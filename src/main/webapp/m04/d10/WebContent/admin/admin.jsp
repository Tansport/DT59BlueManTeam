...
<body>
	...
	<div id="admin_bar">
		<div id="status">
			...
			&#160;&#160;&#160;&#160; <a href="indexput.jsp">login out</a>
		</div>
		<div id="channel"></div>
	</div>
	<div id="main">
		...
		<div id="opt_area">
			...
			<ul class="classlist">
				<%
				    ...
				    /*  BizDaoImpl bdi = new BizDaoImpl();
				        ...
				        bsi.setBizdao(bdi); */
				    List<NewsInfo> list = (List) request.getAttribute("listpage");
				    for (int i = 0; i < list.size(); i++) {
				        NewsInfo nf = list.get(i);
				        out.print("<li>" + nf.getNewsTitle() + "<span>作者:" + nf.getNewsAuthor()
				                + "&#160;&#160;&#160;&#160; <a href='xiu.jsp?xiu=" + nf.getNewsAuthor() + "&xiu2="
				                + nf.getNewsTitle() + "&xiuid=" + nf.getNewsId()
				                + "'>修改</a>&#160;&#160;&#160;&#160; <a href='javascript:;' onclick='del(" + nf.getNewsId()
				                + ");'>删除</a></span></li>");
				    }
				%>
				...
				<p align="center">
					<a href="spage.jsp?currentpage=1">首页</a>&nbsp;&nbsp;&nbsp; <a
						href="spage.jsp?currentpage=<%if ((pg.getCurrentpage() - 1) <= 1) {
                out.print(1);
            } else {
                out.print(pg.getCurrentpage() - 1);
            }%>">上一页</a>
					&nbsp;&nbsp;&nbsp; <a
						href="spage.jsp?currentpage=<%
            ...
            %>">下一页</a>
					&nbsp;&nbsp;&nbsp; <a href=spage.jsp?currentpage=<%=pg.getLastpage() %>>末页</a> &nbsp;&nbsp;&nbsp;
				</p>
			</ul>
		</div>
	</div>
