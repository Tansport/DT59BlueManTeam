...
<body>
	...
	<div id="main">
		...
		<div id="opt_area">
			...
			<form action="add.jsp" method="get" enctype="multipart/form-data"
				...
				<p>
					<label> 标题 </label> <input name="ntitle" type="text"
						class="opt_input" value=<%=session.getAttribute("xiu2")%> />
				</p>
				<p>
					<label> 作者 </label> <input name="nauthor" type="text"
						class="opt_input" value=<%=session.getAttribute("xiu1")%> />
				</p>
				<p>
					<label> 摘要 </label>
