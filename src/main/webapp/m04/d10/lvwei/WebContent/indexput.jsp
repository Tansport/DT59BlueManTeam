...
<%@ page import="entity.comment_info" %>
...
<body>
	<div id="header">
		<div id="top_login">
			<form name="form" method="get" action="info.jsp">
				<label> 登录名 </label> <input type="text" id="uname" name="name"
	...
	<div id="container">
		...
		<div class="main">
			...
			<div class="content">
				...
				bsi.setBizdao(bdi);
				List<comment_info> listt=bsi.all1();
				for(int i=0;i<listt.size();i++){
				    comment_info cif=listt.get(i);
