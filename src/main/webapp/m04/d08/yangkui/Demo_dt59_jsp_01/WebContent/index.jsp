<%@page import="com.dt59.entity.XinInfo"%>
    ...
    <div class="content">
      ...
      <ul class="classlist">
    	...
    	bsi.setBizDao(bdi);//注入
   		List<XinInfo> listnews= bsi.getxin();
   		for(int i=0;i<listnews.size();i++){
   			out.print("<li><a href='#'>"+listnews.get(i).getContent()+"</a><span>"+
   			listnews.get(i).getFbtime()+"</span></li>");
   	}
   	 %>
