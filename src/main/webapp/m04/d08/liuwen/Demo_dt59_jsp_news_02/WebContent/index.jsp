...
<body>
	<div id="header">
		...
		<div id="top_login">
			...
			<label id="error"><%=session.getAttribute("error")%> </label> <img
			...
			<div class="content">
				...
				<ul class="classlist">
					<%
					    ...
					    List<CommentInfo> listcomments = bsi.getComments();
					    for (int i = 0; i < listcomments.size(); i++) {
					        out.print("<li><a href='#'> " + listcomments.get(i).getContent() + "</a><span>"
					                + listcomments.get(i).getFbtime() + "</span></li>");
					    }
					%>
