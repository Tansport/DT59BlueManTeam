 ...
 */	
    ...
    //需要注入
      ...
      List<NewsInfo> listNews= bsi.addTitle();
       for(int i=0;i<listNews.size();i++){
           NewsInfo ni=listNews.get(i);
           out.print("<li>"+listNews.get(i).getNews_title()+"<span>作者:"+listNews.get(i).getNews_author()+"&#160;&#160;&#160;&#160;"+
                   "<a href='modification.jsp?Author=" + ni.getNews_author() + "&Title="
			                + ni.getNews_title() + "&Id=" +ni.getNews_id()
			                + "'>修改</a> &#160;&#160;&#160;&#160;"+
       "<a href='javascript:;' onclick='del("+listNews.get(i).getNews_id()+")'>删除</a> <span><li>");
       }
    	%>
