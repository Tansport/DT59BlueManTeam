...
<form action="result.jsp" method="post">
  <div id="top_login">
    ...
    <label id="error" name="error"><%=session.getAttribute("error") %> </label>
  ...
  <div class="main">
    ...
    <div class="content">
      ...
      <% request.setCharacterEncoding("utf-8");
         ...
         List<CommentInfo> listInfo=bsi.showInfo();
         for(int i=0;i<listInfo.size();i++){
             out.print("<li><a href='#'>"+listInfo.get(i).getContent()+"</a><span> "+
        listInfo.get(i).getFbtime()+" </span></li>");
         } 
      %>
